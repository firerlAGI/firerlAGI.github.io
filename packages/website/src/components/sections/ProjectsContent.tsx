...
import { Brain, Home, Bot, BarChart3, CheckSquare } from 'lucide-react';
    ...
    <div className="flex flex-col items-end text-right mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
        {projects.map((project, index) => {
          ...
          const projectItem = (t.project_items as any)[project.id];
          const title = projectItem?.title || project.title;
          const description = projectItem?.description || project.description;
          const note = projectItem?.note || project.note || 'VIEW PROJECT';
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-3">
                <Icon className={`w-8 h-8 ${index % 2 === 0 ? 'text-fuchsia-400' : 'text-cyan-400'}`} />
                <h3
