    ...
    <section id="contact" className="py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <GlitchText text={t.contact.title} as="h2" className="text-4xl md:text-5xl font-bold text-white mb-4 block" />
          <p className="text-cyan-400 font-mono">{t.contact.subtitle}</p>
        </div>

        <div className="grid md:grid-cols-2 gap-8">
            <CyberCard glowColor="pink" className="flex flex-col justify-center gap-6">
                <h3 className="text-2xl font-cyber text-fuchsia-400 mb-2">{t.contact.channels}</h3>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="relative group">
                    <input type="text" placeholder={t.contact.form.identity} className="w-full bg-black/50 border border-gray-700 p-4 text-white font-mono focus:outline-none focus:border-cyan-500 transition-colors peer" />
                ...
                <div className="relative group">
                    <input type="email" placeholder={t.contact.form.email} className="w-full bg-black/50 border border-gray-700 p-4 text-white font-mono focus:outline-none focus:border-cyan-500 transition-colors" />
                </div>
                <div className="relative group">
                    <textarea rows={4} placeholder={t.contact.form.message} className="w-full bg-black/50 border border-gray-700 p-4 text-white font-mono focus:outline-none focus:border-cyan-500 transition-colors" />
                </div>
