...
const projects: Project[] = [
  {
    id: '1',
    title: 'Neon Nexus',
    description: 'A decentralized social platform built on Web3 technologies with a cyberpunk aesthetic UI.',
  ...
  },
  {
    id: '2',
    title: 'AI Dreamscape',
    description: 'Generative art engine utilizing Gemini Vision API to create real-time dream visualizations.',
  ...
  },
  {
    ...
    description: 'Real-time network traffic visualizer for detecting anomalies in large scale clusters.',
  ...
  return (
    <section id="projects" className="py-20 px-4 max-w-7xl mx-auto">
       <div className="mb-12 flex flex-col items-end text-right">
        <GlitchText text="DEPLOYED MODULES" as="h2" className="text-4xl md:text-5xl font-bold text-white mb-4" />
